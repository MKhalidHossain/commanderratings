...
class CallOfCommanderBodyWidget extends StatefulWidget {
  final GetOneBlog getOneBlog;
  final Blog blog;

  const CallOfCommanderBodyWidget({
    super.key,
    required this.getOneBlog,
    required this.blog,
  });

  @override
  State<CallOfCommanderBodyWidget> createState() =>
      _CallOfCommanderBodyWidgetState();
}

class _CallOfCommanderBodyWidgetState extends State<CallOfCommanderBodyWidget> {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              SubTitleText(
                                text:
                                    widget.getOneBlog.data!.blog!.description!,
                              ),
                            ],
                          ),
                        ),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text(
                                  widget.getOneBlog.data!.blog!.views!
                                      .toString(),
                                  style: TextStyle(
                                ...
                                Text(
                                  widget.getOneBlog.data!.latestComments!.length
                                      .toString(),
                                  style: TextStyle(
                                    color: AppColors.context(context).textColor,
                                  ),
                ...
                Row(
                  children: [
                    LabelText(text: widget.getOneBlog.data!.latestComments!.length.toString()),
                    LabelText(text: ' COMMENTS'),
                  ],
                ),
                const SizedBox(height: 8),
                Column(
                  children: List.generate(widget.getOneBlog.data!.latestComments!.length, (index){
                    return Column(
                      ...
                      children: [
                        ...
                        Text(
                          widget.getOneBlog.data!.latestComments![index].name!,
                        ...
                        ValueTextAeroMatics(
                          text: widget.getOneBlog.data!.latestComments![index].comment!),
                        Align(
                          alignment: Alignment.bottomLeft,
                          child: TextButton(
                            onPressed: () {},
                            child: LabelText(text: 'REPLEY'),
                          ),
                        ),
                      ],
                    );
                ...
                SizedBox(
                  ...
                  child: NormalCustomButton(
                    ...
                    onPressed: () {
                      ...
                      if (name.isEmpty) {
                        showDialog(
                          ...
                          builder: (context) {
                            return AlertDialog(
                              title: Text('Opps ! '),
                              content: Text('Please give the value of Name '),
                              actions: [
                                TextButton(
                                  child: Text('OK'),
                                  onPressed: () {
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return AlertDialog(
                              title: Text('Opps ! '),
                              content: Text('Please Give the value of Email '),
                              actions: [
                                TextButton(
                                  child: Text('OK'),
                                  onPressed: () {
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return AlertDialog(
                              title: Text('Opps ! '),
                              content: Text('Please Give Some message there '),
                              actions: [
                                TextButton(
                                  child: Text('OK'),
                                  onPressed: () {
                      ...
                      commandersCallsController.createCommentUnderBlog(
                        widget.blog.sId!,
                        name,
                        email,
                        message,
